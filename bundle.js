...
/*!**********************!*\
  !*** ./src/const.js ***!
  \**********************/
/*! exports provided: Color, COLORS, SortType, UserAction, UpdateType, FilterType, MenuItem */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _view_statistics__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./view/statistics */ "./src/view/statistics.js");
...
class Filter extends _utils_observer__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    ...
    this._activeFilter = _const__WEBPACK_IMPORTED_MODULE_1__["FilterType"].ALL;
  }
...
class Tasks extends _utils_observer__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    super();
  ...
  updateTask(updateType, update) {
    const index = this._tasks.findIndex((item) => item.id === update.id);
...
class Filter {
  ...
  init() {
    ...
    if (prevFilterComponent === null) {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_1__["render"])(this._filterContainer, this._filterComponent, _utils_render__WEBPACK_IMPORTED_MODULE_1__["RenderPosition"].BEFOREEND);
      return;
    }

    Object(_utils_render__WEBPACK_IMPORTED_MODULE_1__["replace"])(this._filterComponent, prevFilterComponent);
  ...
  _getFilters() {
    ...
    return [
      {
        type: _const__WEBPACK_IMPORTED_MODULE_3__["FilterType"].ALL,
        name: `All`,
        count: _utils_filter__WEBPACK_IMPORTED_MODULE_2__["filter"][_const__WEBPACK_IMPORTED_MODULE_3__["FilterType"].ALL](tasks).length,
      },
      {
        type: _const__WEBPACK_IMPORTED_MODULE_3__["FilterType"].OVERDUE,
        name: `Overdue`,
        count: _utils_filter__WEBPACK_IMPORTED_MODULE_2__["filter"][_const__WEBPACK_IMPORTED_MODULE_3__["FilterType"].OVERDUE](tasks).length,
      },
      {
        type: _const__WEBPACK_IMPORTED_MODULE_3__["FilterType"].TODAY,
        name: `Today`,
        count: _utils_filter__WEBPACK_IMPORTED_MODULE_2__["filter"][_const__WEBPACK_IMPORTED_MODULE_3__["FilterType"].TODAY](tasks).length,
      },
      {
        type: _const__WEBPACK_IMPORTED_MODULE_3__["FilterType"].FAVORITES,
        name: `Favorites`,
        count: _utils_filter__WEBPACK_IMPORTED_MODULE_2__["filter"][_const__WEBPACK_IMPORTED_MODULE_3__["FilterType"].FAVORITES](tasks).length,
      },
      {
        type: _const__WEBPACK_IMPORTED_MODULE_3__["FilterType"].REPEATING,
        name: `Repeating`,
        count: _utils_filter__WEBPACK_IMPORTED_MODULE_2__["filter"][_const__WEBPACK_IMPORTED_MODULE_3__["FilterType"].REPEATING](tasks).length,
      },
      {
        type: _const__WEBPACK_IMPORTED_MODULE_3__["FilterType"].ARCHIVE,
        name: `Archive`,
        count: _utils_filter__WEBPACK_IMPORTED_MODULE_2__["filter"][_const__WEBPACK_IMPORTED_MODULE_3__["FilterType"].ARCHIVE](tasks).length,
      },
    ];
  }
}
...
class TaskNew {
  ...
  init(callback) {
    ...
    this._taskEditComponent = new _view_task_edit__WEBPACK_IMPORTED_MODULE_0__["default"]();
...
/* harmony import */ var _utils_render__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils/render */ "./src/utils/render.js");
/* harmony import */ var _const__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../const */ "./src/const.js");
/* harmony import */ var _utils_task__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../utils/task */ "./src/utils/task.js");
...
class Task {
  ...
  init(task) {
    ...
    this._taskComponent = new _view_task__WEBPACK_IMPORTED_MODULE_0__["default"](task);
    this._taskEditComponent = new _view_task_edit__WEBPACK_IMPORTED_MODULE_1__["default"](task);
    ...
    if (prevTaskComponent === null || prevTaskEditComponent === null) {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["render"])(this._taskListContainer, this._taskComponent, _utils_render__WEBPACK_IMPORTED_MODULE_2__["RenderPosition"].BEFOREEND);
      return;
    }

    if (this._mode === Mode.DEFAULT) {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["replace"])(this._taskComponent, prevTaskComponent);
    }
    ...
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["remove"])(prevTaskEditComponent);
  }

  destroy() {
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["remove"])(this._taskComponent);
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["remove"])(this._taskEditComponent);
  }
  ...
  _replaceCardToForm() {
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["replace"])(this._taskEditComponent, this._taskComponent);
    document.addEventListener(`keydown`, this._escKeyDownHandler);
    this._changeMode();
  ...
  _replaceFormToCard() {
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["replace"])(this._taskComponent, this._taskEditComponent);
    document.removeEventListener(`keydown`, this._escKeyDownHandler);
    this._mode = Mode.DEFAULT;
  }
  ...
  _handleFavoriteClick() {
    this._changeData(
        _const__WEBPACK_IMPORTED_MODULE_3__["UserAction"].UPDATE_TASK,
        _const__WEBPACK_IMPORTED_MODULE_3__["UpdateType"].MINOR,
        Object.assign(
            {},
            this._task,
  ...
  _handleFormSubmit(update) {
    const isMinorUpdate =
      !Object(_utils_task__WEBPACK_IMPORTED_MODULE_4__["isDatesEqual"])(this._task.dueDate, update.dueDate) ||
      Object(_utils_task__WEBPACK_IMPORTED_MODULE_4__["isTaskRepeating"])(this._task.repeating) !== Object(_utils_task__WEBPACK_IMPORTED_MODULE_4__["isTaskRepeating"])(update.repeating);
  ...
  _handleDeleteClick(task) {
    this._changeData(
        _const__WEBPACK_IMPORTED_MODULE_3__["UserAction"].DELETE_TASK,
        _const__WEBPACK_IMPORTED_MODULE_3__["UpdateType"].MINOR,
        task
    );
  }
...
/* harmony import */ var _task__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./task */ "./src/utils/task.js");



// Мапа где ключи - названия фильтров, а значения - функции-счетчики
const filter = {
  [_const__WEBPACK_IMPORTED_MODULE_0__["FilterType"].ALL]: (tasks) => tasks.filter((task) => !task.isArchive),
  [_const__WEBPACK_IMPORTED_MODULE_0__["FilterType"].OVERDUE]: (tasks) => tasks.filter((task) => Object(_task__WEBPACK_IMPORTED_MODULE_1__["isTaskExpired"])(task.dueDate)),
  [_const__WEBPACK_IMPORTED_MODULE_0__["FilterType"].TODAY]: (tasks) => tasks.filter((task) => Object(_task__WEBPACK_IMPORTED_MODULE_1__["isTaskExpiringToday"])(task.dueDate)),
  [_const__WEBPACK_IMPORTED_MODULE_0__["FilterType"].FAVORITES]: (tasks) => tasks.filter((task) => task.isFavorite),
  [_const__WEBPACK_IMPORTED_MODULE_0__["FilterType"].REPEATING]: (tasks) => tasks.filter((task) => Object(_task__WEBPACK_IMPORTED_MODULE_1__["isTaskRepeating"])(task.repeating)),
  [_const__WEBPACK_IMPORTED_MODULE_0__["FilterType"].ARCHIVE]: (tasks) => tasks.filter((task) => task.isArchive),
};
...
/*!*********************************!*\
  !*** ./src/utils/statistics.js ***!
  \*********************************/
/*! exports provided: colorToHex, makeItemsUniq, countTasksByColor, parseChartDate, countTasksInDateRange, getDatesInRange, countCompletedTaskInDateRange */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "countTasksByColor", function() { return countTasksByColor; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "parseChartDate", function() { return parseChartDate; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "countTasksInDateRange", function() { return countTasksInDateRange; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getDatesInRange", function() { return getDatesInRange; });
...
const colorToHex = {
  [_const__WEBPACK_IMPORTED_MODULE_2__["Color"].BLACK]: `#000000`,
  [_const__WEBPACK_IMPORTED_MODULE_2__["Color"].BLUE]: `#0c5cdd`,
  [_const__WEBPACK_IMPORTED_MODULE_2__["Color"].GREEN]: `#31b55c`,
  [_const__WEBPACK_IMPORTED_MODULE_2__["Color"].PINK]: `#ff3cb9`,
  [_const__WEBPACK_IMPORTED_MODULE_2__["Color"].YELLOW]: `#ffe125`,
};
...
const parseChartDate = (date) => moment__WEBPACK_IMPORTED_MODULE_0___default()(date).format(`D MMM`);

const countTasksInDateRange = (dates, tasks) => {
  return dates.map((date) => tasks.filter((task) => Object(_task__WEBPACK_IMPORTED_MODULE_1__["isDatesEqual"])(task.dueDate, date)).length);
};
...
const getDatesInRange = (dateFrom, dateTo) => {
  ...
  while (moment__WEBPACK_IMPORTED_MODULE_0___default()(stepDate).isSameOrBefore(dateTo)) {
...
const countCompletedTaskInDateRange = (tasks, dateFrom, dateTo) => {
  return tasks.reduce((counter, task) => {
    ...
    if (
      moment__WEBPACK_IMPORTED_MODULE_0___default()(task.dueDate).isSame(dateFrom) ||
      moment__WEBPACK_IMPORTED_MODULE_0___default()(task.dueDate).isBetween(dateFrom, dateTo) ||
      moment__WEBPACK_IMPORTED_MODULE_0___default()(task.dueDate).isSame(dateTo)
    ) {
      return counter + 1;
    }
...
/*!***************************!*\
  !*** ./src/utils/task.js ***!
  \***************************/
/*! exports provided: getCurrentDate, isTaskExpired, isTaskExpiringToday, isTaskRepeating, formatTaskDueDate, sortTasksUp, sortTasksDown, isDatesEqual */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "formatTaskDueDate", function() { return formatTaskDueDate; });
...
const isTaskExpired = (dueDate) => {
  ...
  return moment__WEBPACK_IMPORTED_MODULE_0___default()(currentDate).isAfter(dueDate, `day`);
};
...
const isTaskExpiringToday = (dueDate) => {
  ...
  const currentDate = getCurrentDate();
  return moment__WEBPACK_IMPORTED_MODULE_0___default()(dueDate).isSame(currentDate, `day`);
};
...
const formatTaskDueDate = (dueDate) => {
  ...
  return moment__WEBPACK_IMPORTED_MODULE_0___default()(dueDate).format(`D MMMM`);
};
...
const isDatesEqual = (dateA, dateB) => {
  ...
  return moment__WEBPACK_IMPORTED_MODULE_0___default()(dateA).isSame(dateB, `day`);
};
  ...
  return (
    `<section class="control__btn-wrap">
      <input
        ...
        value="${_const__WEBPACK_IMPORTED_MODULE_1__["MenuItem"].ADD_NEW_TASK}"
      />
      ...
      <input
        ...
        id="control__task"
        class="control__input visually-hidden"
        value="${_const__WEBPACK_IMPORTED_MODULE_1__["MenuItem"].TASKS}"
        checked
      />
      ...
      <input
        ...
        class="control__input visually-hidden"
        value="${_const__WEBPACK_IMPORTED_MODULE_1__["MenuItem"].STATISTICS}"
      />
...
const createSortTemplate = (currentSortType) => {
  return (
    `<div class="board__filter-list">
      <a href="#" class="board__filter ${currentSortType === _const__WEBPACK_IMPORTED_MODULE_1__["SortType"].DEFAULT ? `board__filter--active` : ``}" data-sort-type="${_const__WEBPACK_IMPORTED_MODULE_1__["SortType"].DEFAULT}">SORT BY DEFAULT</a>
      <a href="#" class="board__filter ${currentSortType === _const__WEBPACK_IMPORTED_MODULE_1__["SortType"].DATE_UP ? `board__filter--active` : ``}" data-sort-type="${_const__WEBPACK_IMPORTED_MODULE_1__["SortType"].DATE_UP}">SORT BY DATE up</a>
      <a href="#" class="board__filter ${currentSortType === _const__WEBPACK_IMPORTED_MODULE_1__["SortType"].DATE_DOWN ? `board__filter--active` : ``}" data-sort-type="${_const__WEBPACK_IMPORTED_MODULE_1__["SortType"].DATE_DOWN}">SORT BY DATE down</a>
    </div>`
  );
};
...
/* harmony import */ var _utils_task__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../utils/task */ "./src/utils/task.js");
/* harmony import */ var _utils_statistics__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../utils/statistics */ "./src/utils/statistics.js");
...
const renderColorsChart = (colorsCtx, tasks) => {
  ...
  const uniqColors = Object(_utils_statistics__WEBPACK_IMPORTED_MODULE_5__["makeItemsUniq"])(taskColors);
  const taskByColorCounts = uniqColors.map((color) => Object(_utils_statistics__WEBPACK_IMPORTED_MODULE_5__["countTasksByColor"])(tasks, color));
  const hexColors = uniqColors.map((color) => _utils_statistics__WEBPACK_IMPORTED_MODULE_5__["colorToHex"][color]);

  return new chart_js__WEBPACK_IMPORTED_MODULE_1___default.a(colorsCtx, {
...
const renderDaysChart = (daysCtx, tasks, dateFrom, dateTo) => {
  const dates = Object(_utils_statistics__WEBPACK_IMPORTED_MODULE_5__["getDatesInRange"])(dateFrom, dateTo);
  const parsedDates = dates.map(_utils_statistics__WEBPACK_IMPORTED_MODULE_5__["parseChartDate"]);
  const taskInDateRangeCounts = Object(_utils_statistics__WEBPACK_IMPORTED_MODULE_5__["countTasksInDateRange"])(dates, tasks);

  return new chart_js__WEBPACK_IMPORTED_MODULE_1___default.a(daysCtx, {
    plugins: [chartjs_plugin_datalabels__WEBPACK_IMPORTED_MODULE_2___default.a],
    type: `line`,
    data: {
      labels: parsedDates,
...
const createStatisticsTemplate = (data) => {
  ...
  const completedTaskCount = Object(_utils_statistics__WEBPACK_IMPORTED_MODULE_5__["countCompletedTaskInDateRange"])(tasks, dateFrom, dateTo);
...
class Statistics extends _smart__WEBPACK_IMPORTED_MODULE_3__["default"] {
  constructor(tasks) {
    super();
    ...
    this._data = {
      ...
      dateFrom: (() => {
        ...
        const date = Object(_utils_task__WEBPACK_IMPORTED_MODULE_4__["getCurrentDate"])();
        date.setDate(date.getDate() - daysToFullWeek);
        return date;
      })(),
      dateTo: Object(_utils_task__WEBPACK_IMPORTED_MODULE_4__["getCurrentDate"])(),
    };
...
class TaskEdit extends _smart__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  _setDatepicker() {
    ...
    if (this._data.isDueDate) {
      this._datepicker = flatpickr__WEBPACK_IMPORTED_MODULE_3___default()(
...
const createTaskCardTemplate = (task) => {
  ...
  const date = Object(_utils_task__WEBPACK_IMPORTED_MODULE_1__["formatTaskDueDate"])(dueDate);
    ...
    `<article class="card card--${color} ${deadlineClassName} ${repeatClassName}">
      <div class="card__form">
        <div class="card__inner">
          ...
          <div class="card__textarea-wrap">
            <p class="card__text">${he__WEBPACK_IMPORTED_MODULE_2___default.a.encode(description)}</p>
          </div>
